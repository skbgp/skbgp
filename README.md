...
|---------|-------------|------------|
| [dcf_server_iitm](https://github.com/skbgp/dcf_server_iitm) | Offline code judge for IITM DCF lab | HTML, C++, Backend |
| [cardvault](https://github.com/skbgp/cardvault) | Secure card manager with biometric authentication — [Get it on Google Play](https://play.google.com/store/apps/details?id=com.shubham.cardvault) | React Native |
